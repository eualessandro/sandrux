        ...
        <div className="sec-head mb-80">
          <div className="row">
            <div className="col-lg-4">
              <h6 className="title-bord mb-30">Meus Serviços</h6>
            </div>
            <div className="col-lg-8">
              <div className="text">
                <h4>
                  Desde o início de um projeto até sua conclusão, empregamos uma
                  abordagem abrangente e holística que garante que todos os aspectos
                  e estágios sejam tratados de forma cuidadosa e completa.
                </h4>
              </div>
            </div>
          </div>
