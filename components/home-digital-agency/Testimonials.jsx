                  ...
                  <SwiperSlide>
                    <div className="item">
                      <div className="content">
                        <div className="text">
                          <p className="fz-30">
                            O Alessandro transformou completamente nossa experiência digital. 
                            Sua atenção aos detalhes e compreensão profunda do usuário resultaram 
                            em uma interface que nossos clientes adoram usar.
                          </p>
                        </div>
                  ...
                  <SwiperSlide>
                    <div className="item">
                      <div className="content">
                        <div className="text">
                          <p className="fz-30">
                            Trabalhar com o Alessandro foi uma experiência excepcional. 
                            Ele não apenas entregou um design incrível, mas também nos 
                            educou sobre as melhores práticas de UX/UI Design.
                          </p>
                        </div>
                        <div className="info d-flex align-items-center pt-40 mt-40 bord-thin-top">
                          <div>
